...
import RecommendedClinicalBundle from "@/pages/dashboard/clinical-case/RecommendedClinicalBundle";
...
const dashboardRoutes = {
  ...
  children: [
    ...
    {
      path: "clinical-case/recommended-bundle/:quizId",
      element: <RecommendedClinicalBundle />,
    },
    {
