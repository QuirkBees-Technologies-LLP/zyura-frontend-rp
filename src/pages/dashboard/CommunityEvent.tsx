...
const CommunityEvent = () => {
  ...
  const [activeTab, setActiveTab] = useState<string>("social-feed");

  // Check if we're being redirected from forum details with a specific tab
  useEffect(() => {
  ...
  return (
    <div className="my-6 md:my-10">
      ...
      <div className="my-8 lg:my-10">
        <Communities activeTab={activeTab} onTabChange={setActiveTab} />
      </div>
    </div>
  );
};
