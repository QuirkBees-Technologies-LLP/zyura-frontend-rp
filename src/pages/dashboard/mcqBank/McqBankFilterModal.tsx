    ...
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg w-[400px]">
        ...
        <select
          ...
          className="w-full border border-slate-300 p-2 mb-4 cursor-pointer rounded-md"
        >
        ...
        <select
          ...
          className="w-full border border-slate-300 p-2 rounded-md mb-4 disabled:bg-gray-100 cursor-pointer"
        >
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button
            ...
            className="bg-brand text-white px-4 py-2 cursor-pointer rounded-lg hover:bg-brand/90 transition-all"
            disabled={!subject}
          >
            Apply
          </button>
