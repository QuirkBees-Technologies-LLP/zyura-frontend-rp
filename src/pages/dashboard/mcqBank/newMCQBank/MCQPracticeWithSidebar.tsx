                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            {q.options
                              .filter((opt: any) => opt && opt.optionText && String(opt.optionText).trim().length > 0)
                              .map((opt: any, optionIdx: number) => {
                          ...
                          {showAnswers[qId] && (
                            <div className="mt-4 p-4 bg-slate-100 rounded-lg">
                              ...
                              {q.options
                                .filter((option: any) => option && option.optionText && String(option.optionText).trim().length > 0)
                                .map((option: any) => {
