      ...
      <div className="flex justify-between items-center">
        ...
        <Link to={"/dashboard/flashcard-page"}>
          <PrimaryButton
            ...
            iconPosition="left"
            bgColor="bg-brand"
            className="h-12 mb-4 hover:bg-brand hover:opacity-80 cursor-pointer"
          >
            Flashcards Overview
          </PrimaryButton>
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5x mx-auto p-6">
          ...
          <div className="p-6 border rounded-xl border-black/10 flex flex-col gap-4">
            ...
            <button
              ...
              className={`mt-4 w-full flex items-center justify-center gap-4 bg-brand text-white py-2.5 rounded-lg hover:bg-slate-700 cursor-pointer transition-colors ${
          ...
          <div className="p-6 border rounded-xl border-black/10 flex flex-col justify-between gap-4">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className={`w-full flex items-center justify-center gap-4 bg-white border-2 border-brand text-brand py-2.5 rounded-lg hover:bg-violet-50 cursor-pointer transition-colors ${
                  isLoading ? "opacity-50 cursor-not-allowed" : ""
                }`}
              >
                <Atom
