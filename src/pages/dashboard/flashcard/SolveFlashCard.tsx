...
const cardColors = [
  "bg-gradient-to-br from-brand to-brand/80",
  ...
  if (isCompleted) {
    return (
      ...
      >
        ...
        >
          <div className="w-24 h-24 bg-brand/10 rounded-full flex items-center justify-center mb-6 mx-auto">
            <motion.span
              animate={
                // { scale: [1, 1.2, 1] }
                { y: [0, 10, 0] }
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            <Button
              ...
              className="bg-brand hover:bg-brand/90 text-white px-8 py-6 text-lg rounded-xl shadow-lg shadow-brand/30"
              ...
              >
                {isSidebarOpen ? (
                  <div className="flex items-center gap-3">
                    <span className={`flex items-center justify-center w-6 h-6 rounded-full text-[10px] ${index === currentQuestion ? "bg-white text-brand" : "bg-white text-brand"}`}>
                      {index + 1}
                    </span>
        ...
        <div className="flex-1 flex flex-col items-center">
          <div className="w-full max-w-3xl mb-8 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-xs font-bold text-brand uppercase tracking-widest mb-1">Current Progress</span>
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md">
                        ...
                        {questions[currentQuestion]?.explanation && (
                          ...
                          >
                            <div className="absolute -top-3 left-6 px-3 bg-brand text-white text-[9px] font-bold rounded-lg py-1 shadow-md">
                              EXPLANATION
                            </div>
          ...
          <div className="flex items-center justify-between w-full max-w-3xl mt-12 px-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                onClick={handleNext}
                className="bg-brand hover:bg-brand/90 text-white font-bold rounded-full px-12 py-6 shadow-lg shadow-brand/30 flex items-center gap-2"
              >
