...
const MedicalEventsDashboard: React.FC = () => {
  ...
  // ✅ Handle incoming navigation state to set the correct tab
  useEffect(() => {
    if (location.state?.activeTab) {
      // Map the incoming tab name to the display name
      const tabMapping: { [key: string]: string } = {
        ...
        "community": "Social Feed", // Default fallback
      };
      
      const mappedTab = tabMapping[location.state.activeTab] || "Social Feed";
