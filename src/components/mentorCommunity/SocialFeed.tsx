      ...
      <div className="w-full max-w-7xl mx-auto px-2">
        ...
        <div className="w-full flex flex-col gap-4">
          {isError && (
            ...
            >
              We could not load the social feed. Refresh the page or try again
              in a moment.
            </div>
          )}

          {!isError && posts.length === 0 && (
            <div className="rounded-lg border border-dashed border-slate-200 bg-slate-50 px-4 py-10 text-center text-slate-600">
              <p className="font-medium text-slate-800">No posts yet</p>
              <p className="mt-1 text-sm">
                Be the first to share a tip or start a discussion using the form
                below.
              </p>
            </div>
          )}
