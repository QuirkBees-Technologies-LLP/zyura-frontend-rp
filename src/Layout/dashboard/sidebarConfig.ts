...
// Learner dashboard (STUDENT + PROFESSIONAL): same sidebar — omit these labels
// (Diagram, Drug Cards, CME/CPD, Resources, Upgrade Plan).

export const LEARNER_DASHBOARD_EXCLUDED_SIDEBAR_LABELS = new Set([
  "Diagram",
  "Drug Cards",
  "CME/CPD Courses",
  "Resources",
...
export function filterSidebarItemsForLearnerDashboard(
  items: SidebarItem[],
): SidebarItem[] {
  return items.filter((i) => !LEARNER_DASHBOARD_EXCLUDED_SIDEBAR_LABELS.has(i.label));
}
